...
!function(root, factory) {
    ...
    function Datepicker(options) {
        ...
        this.dateJson         = options.dateJson;
        this.dateString       = JSON.stringify(this.dateJson);

        // cache after props set
        var self = this;

        // dateJson can't be empty
        if (!this.dateJson) {
            throw 'dateJson can not be empty! Please set the option item.';
        }
    ...
    var UTILS = {
        ...
        getDateObj: function(dateJson, date) {
        ...
        renderSinglePicker: function(year, month, datepickerObj) {
            ...
            return $tpl.append(this.renderPickerBody(arr, currentDate, endDate, initDate, datepickerObj.dateJson, datepickerObj.dateString));
        },
        ...
        renderPickerBody: function(arr, currentDate, endDate, initDate, dateJson, dateString) {
            var self = this,
                tmp = '';
            ...
            for (var i = 0; i < arr.length; i++) {
                ...
                (function(i) {
                    var itemArr = arr[i].split('/'),
                        ...
                        formatedDate = self.formatDateString(arr[i], '-'),
                        className = '',
                        dateObj = null;
                    ...
                    // has quota
                    className += (dateString.indexOf(formatedDate) > -1) ? ' has-quota' : '';
                    // is quota > 0
